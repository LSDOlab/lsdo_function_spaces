...
def _check_if_load_stored_import(
    ...
    # Invalidate cache if it was built with the legacy BSplineSpace class.
    for function in function_set.functions.values():
        if not isinstance(function.space, lfs.BSplineSpaceNew):
            return None
...
def import_file(
    ...
    # Cache spaces
    space_cache: Dict[str, lfs.BSplineSpaceNew] = {}
